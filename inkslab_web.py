...
<div id="tab-settings" class="panel">
  <div class="dl-section">
    ...
    <div class="settings-subhead">Timing</div>
    <div class="form-row">
...
<nav class="bottom-nav">
  ...
  <div class="sb-widget">
    <div class="sb-widget-label">Quick Switch Collection</div>
